      ...
      <div className="body">
        <section className="cards">
          <article className="card">
            ...
            <a href="https://github.com/mishakessler" target="_blank"><img src={'https://addons-media.operacdn.com/media/extensions/25/170925/1.0.3-rev1/icons/icon_64x64_dd4e801f8a3053029c874cde7512b1e4.png'} alt="github-logo" /></a>
          </article>
          ...
          <article className="card">
            ...
            <a href="https://github.com/n95babu" target="_blank"> <img src={'https://addons-media.operacdn.com/media/extensions/25/170925/1.0.3-rev1/icons/icon_64x64_dd4e801f8a3053029c874cde7512b1e4.png'} alt="github-logo" /></a>
          </article>
          ...
          <article className="card">
            ...
            <a href="https://github.com/seanbfield" target="_blank"><img src={'https://addons-media.operacdn.com/media/extensions/25/170925/1.0.3-rev1/icons/icon_64x64_dd4e801f8a3053029c874cde7512b1e4.png'} alt="github-logo" /></a>
          </article>
        </section>
      </div>
      <CallToAction />
